...
class LoginPage(BasePage):
    ...
    def should_be_login_url(self):
        assert "login" in self.browser.current_url, "The current page does not contain 'login'"
    ...
    def should_be_register_form(self):
        assert self.is_element_present(
            *LoginPageLocators.LOGIN_FORM), "Register form is not presented"
    ...
    def register_new_user(self, email, password):
        ...
        self.browser.find_element(*LoginPageLocators.PASSWORD_CONFIRM_REGISTER).send_keys(password)
